class ProjectUtils {
  ...
  static const List<String> description = [
    "'Musica'It's an offline music player with basic features with the help of Flutter Its Available in Play Store now.",
    "Application of JobEzy,Its helped to find the jobs,hiring new employees and its acts as a social media. Developed using Flutter",
    "Its a Freelance Project its named Family Tree is a application for store a family details The project is all about creating and view all family members,Using Flutter and Firebase",
  ...
  static const List<String> links = [
    "https://play.google.com/store/apps/details?id=in.brototype.music_app&hl=en_IN&gl=US",
    "https://github.com/aneeshdevala/JobEzy",
    "https://github.com/aneeshdevala/Family_Tree",
